...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id="home"
      className="relative pt-24 pb-12 min-h-[90vh] flex items-center overflow-hidden bg-black"
    >
      {/* Background patterns */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 order-2 lg:order-1 text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Dra. Leonice Dias oferece suporte jurídico especializado em causas
              Cíveis, Previdenciárias e Trabalhistas, transformando desafios
              legais em soluções humanas.
            </p>
              ...
              <div className="relative w-full aspect-square md:aspect-[4/5] rounded-2xl overflow-hidden border-2 border-[#d4af37]/30 shadow-2xl bg-zinc-900">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 md:p-8 bg-gradient-to-t from-black via-black/80 to-transparent">
                  <p className="text-white font-serif text-lg md:text-xl italic leading-snug">
                    "Cada direito respeitado é uma vitória para quem confia na
                    justiça." ⚖️✨
                  </p>
                  <div className="flex items-center space-x-3 mt-4">
                    <div className="h-px w-8 bg-[#d4af37]"></div>
                    <p className="text-[#d4af37] text-xs md:text-sm font-bold tracking-[0.2em] uppercase">
                      Leonice Dias
                    </p>
                  </div>
                </div>
